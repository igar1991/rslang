    ...
    if (errorsChecking()) {
      ...
      if ('data' in newUser) {
        ...
        if ('data' in authUser) {
          ...
          createStatistics({
            id: newUser.data.id,
            body: { learnedWords: 0, optional: { achievements: achievementsObj, statToday: {date: newDate, sprint:{rightAnswers:0,errorAnswers:0,newWords:0,series:0}, audioCall: {rightAnswers:0,errorAnswers:0,newWords:0,series:0}} } }
          });
